                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><div class="d-flex align-items-center"><img src="{{asset('admin/images/avatar/1jpg')}}" class="rounded-lg me-2" width="24" alt=""/> <span class="w-space-no">Dr. Jackson</span></div></td>
											...
											<tr>
                                                ...
                                                <td><strong>542</strong></td>
                                                <td><div class="d-flex align-items-center"><img src="{{asset('admin/images/avatar/2jpg')}}" class="rounded-lg me-2" width="24" alt=""/> <span class="w-space-no">Dr. Jackson</span></div></td>
                                                <td>example@example.com	</td>
                                                <td>01 August 2020</td>
											...
											<tr>
                                                ...
                                                <td><strong>542</strong></td>
                                                <td><div class="d-flex align-items-center"><img src="{{asset('admin/images/avatar/3jpg')}}" class="rounded-lg me-2" width="24" alt=""/> <span class="w-space-no">Dr. Jackson</span></div></td>
                                                <td>example@example.com	</td>
                                                <td>01 August 2020</td>
