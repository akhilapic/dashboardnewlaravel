                                ...
                                <div id="DZ_W_Todo3" class="widget-media dlab-scroll height370">
                                    <ul class="timeline">
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                <div class="media me-2 media-success">
													<img alt="image" width="50" src="{{asset('admin/images/avatar/2.jpg')}}">
												</div>
												<div class="media-body">
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                <div class="media me-2 media-primary">
													<img alt="image" width="50" src="{{asset('admin/images/avatar/3.jpg')}}">
												</div>
												<div class="media-body">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <div class="profile-photo">
										<img src="{{asset('admin/images/profile/profile.png')}}" width="100" class="img-fluid rounded-circle" alt="">
									</div>
                                ...
                                <div class="widget-media">
									<ul class="timeline">
										<li>
											<div class="timeline-panel">
												<div class="media me-2">
													<img alt="image" width="50" src="{{asset('admin/images/avatar/4.jpg')}}">
												</div>
												<div class="media-body">
													<h5 class="mb-1">Dr sultads Send you Photo</h5>
													<small class="d-block">29 July 2020 - 02:26 PM</small>
