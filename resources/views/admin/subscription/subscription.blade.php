<x-header title="Subscription Details"/>
@include("inc.sidebar");
<!--*********************Content body start***********************************-->
        <!--**********************************
            Content body start
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600  me-auto">Subscription List</h4>
					<div>
					<a href="javascript:void(0);" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add New User</a>
